const AED_UNITS = {
  "0": {
    ...
    "description": "You will build engineering habits, safety routines, documentation practices, and early design-process skills through a hands-on launch pad challenge.",
    "lessons": [
  ...
  "1": {
    ...
    "description": "You will communicate engineering designs through sketching, measurement, tolerances, assembly documentation, bills of materials, change records, and final proposal presentations.",
    "lessons": [
  ...
  "2": {
    ...
    "description": "You will create accurate CAD part models, prepare files for 3D printing, complete the FabLab 3D printer workflow, and print a tolerance tester that supports the next rocket assembly unit.",
    "lessons": [
  ...
  "3": {
    ...
    "description": "You will build a full rocket CAD assembly, check fit and alignment, 3D print and physically assemble a prototype, test the assembly, and create technical drawings for final presentation.",
    "lessons": [
  ...
  "4": {
    ...
    "description": "You will investigate materials, mechanisms, motion, friction, data, statistics, circuits, motors, and electromechanical systems through an aerospace prototype challenge.",
    "lessons": [
  ...
  "5": {
    ...
    "description": "You will complete a final human-centered aerospace design capstone that uses user research, ethics, sustainability, life-cycle thinking, project management, prototyping, testing, feedback, revision, portfolio evidence, and final presentation.",
    "lessons": [

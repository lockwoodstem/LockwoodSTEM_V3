(function () {
  ...
  const finalQuestions = [
    ...
    {
      id: "q3",
      question: "You should use Bambu P1S/A1 Mini and Robo E3/E4 printers:",
      choices: [
    ...
    {
      id: "q13",
      question: "You should avoid reaching into the printer while:",
      choices: [
    ...
    {
      id: "q16",
      question: "After printing, you should remove the part:",
      choices: [
